test_that("SDAI gives correct answer", {
  expect_equal(sdai_score(tjc=4,sjc=5,ptgh=5,phgh=6,crp=7), 27)
  expect_equal(sdai_score(tjc=4:5,sjc=5:6,ptgh=5:6,phgh=6:7,crp=7:8), c(27,32))
  expect_equal(sdai_score(tjc=NA,sjc=5,ptgh=6,phgh=6,crp=7), NA_real_)
  expect_equal(sdai_score(tjc=4,sjc=NA,ptgh=6,phgh=6,crp=7), NA_real_)
  expect_equal(sdai_score(tjc=4,sjc=5,ptgh=NA,phgh=6,crp=7), NA_real_)
  expect_equal(sdai_score(tjc=4,sjc=5,ptgh=6,phgh=NA,crp=7), NA_real_)
  expect_equal(sdai_score(tjc=4,sjc=5,ptgh=6,phgh="A",crp=7), NA_real_)
  expect_equal(sdai_score(tjc=30,sjc=5,ptgh=6,phgh=5,crp=7), NA_real_)
  expect_equal(sdai_score(tjc=4,sjc=5,ptgh=6,phgh=5,crp=-1), NA_real_)

})

test_that("SDAI throws error for incorrect parameters", {
  expect_error(sdai_score(tjc=66,sjc=5,ptgh=5,phgh=6,crp=7, ignore = FALSE))
  expect_error(sdai_score(tjc=26,sjc=32,ptgh=5,phgh=6,crp=7, ignore = FALSE))
