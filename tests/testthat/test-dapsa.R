...
test_that("DAPSA percentage response gives correct answer", {
...
test_that("DAPSA percentage response throws error for incorrect parameters", {
  expect_error(dapsa_classification(12, "A", ignore = FALSE))
  expect_error(dapsa_classification(-4, "B", ignore = FALSE))
  expect_error(dapsa_classification(NA, NA, ignore = FALSE))
})
