test_that("DAPSA gives correct answer", {
  expect_equal(dapsa_score(tjc=4,sjc=5,pain=7,ptgh=6,crp=7, crp_unit='mg/dL'), 29)
  expect_equal(dapsa_score(tjc=4,sjc=5,pain=7,ptgh=6,crp=7, crp_unit='mg/L', digits=1), 22.7)
  expect_equal(dapsa_score(tjc=NA,sjc=5,pain=7,ptgh=6,crp=7, crp_unit='mg/dL'), NA_real_)
  expect_equal(dapsa_score(tjc=4,sjc=NA,pain=7,ptgh=6,crp=7, crp_unit='mg/dL'), NA_real_)
  expect_equal(dapsa_score(tjc=4,sjc=5,pain=NA,ptgh=6,crp=7, crp_unit='mg/dL'), NA_real_)
  expect_equal(dapsa_score(tjc=4,sjc=5,pain=7,ptgh=NA,crp=7, crp_unit='mg/dL'), NA_real_)
  expect_equal(dapsa_score(tjc=4,sjc=5,pain=7,ptgh=6,crp="High", crp_unit='mg/dL'), NA_real_)
  expect_equal(dapsa_score(tjc=4:5,sjc=5:6,pain=7:8,ptgh=6:7,crp=7:8, crp_unit='mg/dL'), c(29, 34))
})

test_that("DAPSA throws error for incorrect parameters", {
  expect_error(dapsa_score(tjc=NA,sjc=5,pain=7,ptgh=6,crp=7, crp_unit='mg/dL', ignore = FALSE))
  expect_error(dapsa_score(tjc=4,sjc="A",pain=7,ptgh=6,crp=7, crp_unit='mg/dL', ignore = FALSE))
  expect_error(dapsa_score(tjc=4,sjc=5,pain="B",ptgh=6,crp=7, crp_unit='mg/dL', ignore = FALSE))
  expect_error(dapsa_score(tjc=4,sjc=5,pain=7,ptgh="C",crp=7, crp_unit='mg/dL', ignore = FALSE))
  expect_error(dapsa_score(tjc=4,sjc=5,pain=7,ptgh=6,crp="D", crp_unit='mg/dL', ignore = FALSE))
  expect_error(dapsa_score(tjc=4:5,sjc=5,pain=7:8,ptgh=6:7,crp=7:8, crp_unit='mg/dL'))
})
